...
public class RePushMallService {
    ...
    public List<RePushMallBO> queryValidMalls() {
        ...
        return rePushMalls.stream().filter(m -> {
            if ("peets".equals(m.getMallName()) || "seesaw".equals(m.getMallName()) || "marzano".equals(m.getMallName()) || "theplace".equals(m.getMallName()) || "shdabangsquare".equals(m.getMallName()) || "jinhongqiao".equals(m.getMallName()) || "raffles".equals(m.getMallName())) {  // 特殊商场
                return false;
